...
![PSLab Wave Pins](../images/pslab_wave_pins.png){ width="24%" } ![Robotic Arm Kit](../images/robotic_arm_kit.jpg){ width="24%" } ![SG90 Servo](../images/sg90_servo.jpg){ width="24%" } ![Jumper Wires](../images/jumper_wires.jpg){ width="24%" }
...
![Robotic Arm Interface](../images/img_robotic_arm3.png){ align="right" width="200" }

1. Open the **PSLab app**.
2. Navigate to the **Robotic Arm** instrument.
...
![Robotic Arm Timeline 1](../images/img_robotic_arm1.png){ width="49%" } ![Robotic Arm Timeline 2](../images/img_robotic_arm2.png){ width="49%" }

*Watch our video guides for a visual walkthrough:*  
[Video 1](https://youtu.be/zZ33pp560KA?si=OruiWHxXW4BBUqOx) | [Video 2](https://youtu.be/IFSByhxeXV4?si=CTsC6272dFxwbhG-)
